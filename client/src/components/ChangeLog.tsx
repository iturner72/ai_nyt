  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="relative bg-white w-11/12 md:w-3/4 lg:w-3/6 h-bvh p-6 shadow-lg rounded-none">
        ...
        <h2 className="ib text-5xl font-bold pt-10 mb-4">change log & feature roadmap</h2>
        <div className="ir mb-6">
          <h3 className="ib text-3xl font-semibold mb-2">change log</h3>
        ...
        <div>
          <h3 className="ib text-3xl font-semibold mb-2">feature roadmap</h3>
          <ol className="ir text-xl pl-6">
